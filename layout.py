...
def render_header():
    ...
    st.markdown(
        'Formulario de inscrição para as palestras:<br>'
        '<a href="https://forms.gle/7o9BC76m5C2U6xPG7" target="_blank" style="font-size:16px; font-weight:bold;">Formulário de Inscrição</a>',
        unsafe_allow_html=True
    )
    st.markdown(
